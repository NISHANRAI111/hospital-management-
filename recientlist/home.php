...
$receptionist_id = $pdo->query("SELECT receptionist_id FROM receptionists WHERE user_id = " . $_SESSION['user_id'])->fetchColumn();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Home - Receptionist Dashboard</title>
...
<body>
    ...
    <section class="main">
        ...
        <div class="main-content" id="home">
            ...
            <p>Manage patient registrations, appointments, and billing here.</p>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status === 'success') {
                    ...
                    $('#appointments-list').html('<p>No appointments today.</p>');
                }
            }
        });
    });
