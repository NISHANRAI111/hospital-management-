...
<head>
    ...
    <title>Rate - Receptionist Dashboard</title>
...
<body>
    ...
    <section class="main">
        ...
        <div class="main-content" id="rate">
            ...
            <p>Note: Receptionists typically don’t receive direct feedback. This shows general system feedback.</p>
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status === 'success') {
                    ...
                    $('#feedback-list').html('<p>No feedback available.</p>');
                }
            }
        });
    });
